...
date: 2025-12-10
permalink: /posts/2025/12/gradient-descent/
tags:
  - gradient descent
  - deep learning
  - machine learning
...
In all of these methods, we will denote $\boldsymbol{\theta}\_{t}$ to be the parameters of our objective function at time $t$, we will denote $\mathbf{g}\_t$ to be the Euclidean gradient of our objective function with respect to our parameters at time $t$, we will denote $\circ$ to be the [Hadamard product](https://en.wikipedia.org/wiki/Hadamard_product_(matrices)), and allow for broadcasting.
